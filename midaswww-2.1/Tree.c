...
void CvtStringToGravity (args, num_args, fromVal, toVal)
    XrmValuePtr args;
    Cardinal    *num_args;
    XrmValuePtr fromVal;
    XrmValuePtr toVal;
...
static void ClassInitialize ()
{
    XtAddConverter (XtRString, XtRGravity, CvtStringToGravity,
    ...
    Widget grequest, gnew;
{
    ...
    new->tree.tree_root = XtCreateWidget ("root", widgetClass, gnew, args,((Cardinal) 2));
...
TreeForceLayout (Widget tree)
#else
TreeForceLayout (tree)
    Widget tree;
#endif
{
